            ...
            <div className="flex items-center space-x-6 rtl:space-x-reverse">
              ...
              <div className="links flex gap-4">
                {UserLogin != null ? (
                  <span
                    onClick={() => signOut()}
                    className="text-base cursor-pointer bg-red-400 dark:bg-red-600 text-white p-2 rounded-xl font-semibold hover:text-gray-600 dark:hover:text-gray-300"
                  >
                    SignOut
                  </span>
                ) : (
                  <>
                    <Link to="login" className="text-sm bg-emerald-600 p-2 rounded-md text-white font-bold">
                      Login
                    </Link>
                    <Link to="signup" className="text-sm bg-emerald-600 p-2 rounded-md text-white font-bold">
                      Register
                    </Link>
                  </>
                )}
